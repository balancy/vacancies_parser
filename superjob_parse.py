...
def gather_statistics(api_key, language):
    """Gathering statistics such as average salary and total vacancies found
    for a specified language.

    :param language: language to search vacancies on
    ...
    return format_statistics(total, predicted_salaries)
...
if __name__ == "__main__":
    ...
    for language in languages:
        try:
            statistics[language] = gather_statistics(
                superjob_api_key,
                language,
            )
